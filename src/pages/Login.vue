<template>
  <div
    class="relative min-h-screen w-full flex justify-center overflow-x-hidden"
  >
    ...
    <div class="flex items-center w-full max-w-7xl">
      <div class="w-full sm:w-auto">
        <v-card
          class="shadow-md min-h-screen lg:min-h-0 lg:h-auto w-full sm:w-md flex flex-col items-start justify-start lg:justify-center px-4 sm:px-5"
          flat
        >
          <div class="w-full flex flex-col mt-10 sm:mt-20">
            <div
              class="w-full max-w-65 flex flex-col lg:hidden items-center self-center"
            >
              <img
                class="w-65"
            ...
            <div
              class="grow items-center justify-center lg:mt-0 mb-10 sm:mb-20"
            >
