<template>
  ...
  <v-dialog v-model="viewProcedureDetails">
    <procedure-details
      :procedure-data="procedureData"
      @close="viewProcedureDetails = false"
    />
  </v-dialog>

  <v-dialog v-model="editProcedure" class="z-999">
    <procedure-form
      :model-value="selectedProcedure"
      @close="editProcedure = false"
      @save="submit"
    />
  </v-dialog>
</template>
...
const tooltipTextDelete =
  "Não é possível excluir o procedimento enquanto houver solicitações vinculados a ele.";
